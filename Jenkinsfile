pipeline {
  ...
  environment {
    ...
    EXT_GIT_BRANCH = 'main'
    EXT_USER = 'alexjustesen'
    EXT_REPO = 'speedtest-tracker'
    BUILD_VERSION_ARG = 'SPEEDTEST_TRACKER_VERSION'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-speedtest-tracker'
    CONTAINER_NAME = 'speedtest-tracker'
    DOCKERHUB_IMAGE = 'linuxserver/speedtest-tracker'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/speedtest-tracker'
    PR_DOCKERHUB_IMAGE = 'lspipepr/speedtest-tracker'
    DIST_IMAGE = 'alpine'
    MULTIARCH='true'
    CI='true'
    CI_WEB='true'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-speedtest-tracker/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-speedtest-tracker\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-speedtest-tracker\" \
